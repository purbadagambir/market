        ...
        <div class='order-info'>
            <table class='w-100'>
                ...
                <tr>
                    ...
                    <td>: {{number_format(intval($data['price']->subtotal))}}</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="3" class='w-50'>Diskon</td>
                    <td>: {{number_format(intval($data['price']->discount_amount))}}</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="3" class='w-50'>Total</td>
                    <td>: {{number_format(intval($data['price']->subtotal - $data['price']->discount_amount))}}</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="3" class='w-50'>Dibayar</td>
                    <td>: {{number_format(intval($data['payment']->total_paid))}}</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="3" class='w-50'>Sisa</td>
                    <td>: {{number_format(intval($data['payment']->pos_balance))}}</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="3" class='w-50'>Set Ke Kredit</td>
                    <td>: {{number_format(intval($data['payment']->balance_to_credit))}}</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="3" class='w-50'>Kembalian</td>
                    <td>: {{number_format(intval($data['payment']->pos_balance - $data['payment']->balance_to_credit))}}</td>
                </tr>
            </table>
        </div>
