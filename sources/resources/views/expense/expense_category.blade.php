      ...
      <div class="box-body">
        <form class="form-horizontal">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="categoryname" class="col-sm-3 control-label">Category Slug</label>
              <div class="col-sm-7">
                <input v-model="form.unit_name" type="text" name="label" class="form-control" id="form_label">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Category Details</label>
              <div class="col-sm-7">
              ...
              <table id="datatable" class="table table-bordered table-striped">
                <thead>
                  <tr role="row" class="bg-gray">
                    ...
                    <th class="text-center">Short Order</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td style="text-align: center; vertical-align: middle;">setup tempat</td>
                    <td style="text-align: center; vertical-align: middle;">1</td>
                    <td style="text-align: center; vertical-align: middle;">0</td>
                    <td style="text-align: center; vertical-align: middle;">2022-09-07 21:24:15</td>
...
<script src="assets/js/page/expense_category.js"></script>
